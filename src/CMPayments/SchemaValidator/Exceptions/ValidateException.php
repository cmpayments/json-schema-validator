...
class ValidateException extends BaseException
{
    ...
    protected $messages = [
        ...
        self::ERROR_USER_NUMBER_MINIMUM_CHECK                     => 'The minimum value for property \'%s\' is \'%g\' (current value \'%g\')',
        self::ERROR_USER_NUMBER_MAXIMUM_CHECK                     => 'The maximum value for property \'%s\' is \'%g\' (current value \'%g\')',
